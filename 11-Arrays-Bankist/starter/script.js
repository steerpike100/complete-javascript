...
// ///////////////////////////////////////
//
// const owners = ['Jonas', 'Zach', 'Adam', 'Martha', 'Pike'];
...
// // //console.log(z)
// //
// // const v = Array.from({length: 100}, ( ) => Math.floor(Math.random() * 6) + 1)
// // //console.log(v)
//
//
// /*
...
// let enough = sarahDog.curFood > (sarahDog.recommendedFood * 0.90) && sarahDog.curFood < (sarahDog.recommendedFood * 1.10)
//     ? `Sarahs dog is eating enough`
//     : `Sarahs dog is not eating enough`;
// console.log(enough)
//
// // const dogFoodHealth = (dog) => ((dog.curFood > (dog.recommendedFood * 0.90) && dog.curFood < (dog.recommendedFood * 1.10)))
//
// //3.
...
//
// //7.
// const okayFood = dogs.filter(dog =>dog.curFood > (dog.recommendedFood * 0.90) && dog.curFood < (dog.recommendedFood * 1.10));
// console.log(`Dogs eating an okay food! ${okayFood}`);
//
// //8.
// const dogsSorted = dogs.slice().sort((a, b) => a.recommendedFood - b.recommendedFood);
// console.log(`Dog Sorted: ${dogsSorted}`);
